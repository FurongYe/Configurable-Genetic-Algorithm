...
int main(int argc, const char *argv[])
{
  ...
  // string algorithm_name = "ea";
  // string suite_name = "pbo";
  // string problem_str = "1-2";
  // string instance_str = "1-5";
  // string dimension_str = "100";
  // string dir = "./";
  // int runs = 10;
  // int budget = 5000;
  // unsigned seed =  static_cast<unsigned> (1);
