...
namespace ioha {
  namespace operators{
    ...
    public:
      ...
      void do_crossover(vector<int>& y, const vector<int>& x1, const vector<int>& x2) {
        switch (this->crossover_operator_) {
        case 1:
          this->uniform_crossover(y, x1, x2);
          break;
        case 2:
          this->one_point_crossover(y, x1, x2);
          break;
        case 3:
          this->two_point_crossover(y, x1, x2);
          break;
        default:
      ...
      void uniform_crossover(vector<int>& y, const vector<int>& x1, const vector<int>& x2) {
      ...
      void one_point_crossover(vector<int>& y, const vector<int>& x1, const vector<int>& x2) {
        assert(x1.size() == x2.size());
      ...
      void two_point_crossover(vector<int>& y, const vector<int>& x1, const vector<int>& x2) {
        assert(x1.size() == x2.size());
