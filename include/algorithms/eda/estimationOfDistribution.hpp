...
namespace ioha
{
  namespace alg
  {
    namespace eda
    {
      class EstimationOfDistribution : public ioha::IOHA
      {
      public:
        ...
        virtual void opt()
        {
          ...
          while (!this->termination())
          {
            ...
            {
              this->sample_individual(this->variables_distribution_, this->offspring_population_[i]);
            ...
            if (this->termination())
              break;
            this->selection();
            this->estimate_variables_distribution();
          }
        };
        ...
        void estimate_variables_distribution()
        {
          for (size_t i = 0; i != this->get_dimension(); ++i)
          {
        ...
        void sample_individual(const vector<vector<double>> &distributions, vector<int> &individual)
        {
