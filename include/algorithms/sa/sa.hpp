    ...
    namespace alg
    {
        namespace sa
        {
                                         ...
                                         const unsigned long long eval_budget)
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    xcur.push_back((int)(2 * ioha::operators::uniform_random()));
                }
                ...
                while (((++step) <= eval_budget) && (!problem->state().optimum_found))
                {
                    ...
                    do
                    {
                        ...
                        for (int i = n; (--i) >= 0;)
                        {
                            if (ioha::operators::uniform_random() < p)
                            {
                    ...
                    if ((ynew >= ycur) || (ioha::operators::uniform_random() < p_accept(ycur - ynew, temperature(Tstart, epsilon, step))))
                    {
                        ycur = ynew;
                        xcur = xnew;
                    }
